                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        ...
                        <div class="box-boby" style="padding-left: 12px">
                            <a href="/user/form" type="button" class="btn btn-default btn-sm"><i class="fa fa-plus-square"> 新增</i></a>
                            <button class="btn btn-default btn-sm" onclick="App.deleteMulti('/user/delete')"><i class="fa fa-trash"> 删除</i></button>
                            ...
                            <table id="dataTable" class="table table-hover">
                                ...
                                <c:forEach items="${tbUsers}" var="tbUsers">
                                    <tr>
                                        ...
                                        <td>${tbUsers.phone}</td>
                                        <td><span class="label label-info">${tbUsers.email}</span></td>
...
<script>
    ...
    $(function () {
        ...
        [
            ...
            { "data": function (row,type,val,meta) {
                var dataURL = "/user/detail?id=" + row.id;
                return  '<button type="button" class="btn btn-info" onclick="App.showDetail(\''+dataURL+'\')"><i class="fa fa-search">查看</i></button>\n' +
                        '<a href="/user/form?id='+row.id+'" type="button" class="btn btn-warning"><i class="fa fa-edit">编辑</i></a>\n' +
                        '<button class="btn btn-danger" onclick="App.delete(\'/user/delete\','+row.id+')"><i class="fa fa-trash">删除</i></button>';
                }
            }
        ];
