...
<div id="header">
    <div class="header-box">
        ...
        <ul class="header-right">
            <c:if test="${tbUserDto != null}">
                <li class="denglu">Hi~${tbUserDto.username}欢迎回来<a class="red" href="/logout">[注销]</a></li>
            </c:if>
            <c:if test="${tbUserDto == null}">
...
<div id="lunbo">
    ...
    <ul id="two">
        <c:forEach items="${ppt}" varStatus="pptStatus">
            <li class="${pptStatus.count== 1 ? "on" : ""} ">${pptStatus.count}</li>
        </c:forEach>
        <%--<li class="on">1</li>--%>
        <%--<li>2</li>--%>
        <%--<li>3</li>--%>
